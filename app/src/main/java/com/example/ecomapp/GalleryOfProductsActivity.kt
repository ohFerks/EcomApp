...
class GalleryOfProductsActivity : AppCompatActivity() {
    ...
    private val productList = mutableListOf<Product>() // Полный список продуктов
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupSearchBox() // Подключаем поиск
    }
    ...
    private fun loadProductsFromDatabase() {
        databaseReference.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                filteredList.clear()
                filteredList.addAll(productList) // Сначала показываем весь список
